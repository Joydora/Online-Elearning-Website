                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                            <Card className="p-5">
                                <p className="text-sm text-zinc-500 dark:text-zinc-400">Đang giữ</p>
                                <p className="mt-1 text-2xl font-bold text-yellow-600">
                                    {fmt(data?.heldAmount ?? 0)}
                                </p>
                            </Card>
                            <Card className="p-5">
                                <p className="text-sm text-zinc-500 dark:text-zinc-400">Đã chi trả</p>
                                <p className="mt-1 text-2xl font-bold text-green-600">
                                    {fmt(data?.paidAmount ?? 0)}
                                </p>
                            </Card>
                            <Card className="p-5">
                                <p className="text-sm text-zinc-500 dark:text-zinc-400">Số giao dịch</p>
